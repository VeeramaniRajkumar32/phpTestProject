                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <label class="custom-file-label" for="customFile">Upload Cover letter</label>
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <input type="file" id="appointment_letter" name="appointment_letter" class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <table class="table mb-4" id="zero-config">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Offer_Copy</th>
                                                <th class="text-center">Appoinment_Copy</th>
                                                            ...
                                                            <div class="d-flex">
                                                                <div class="mr-2 rounded-circle">
                                                                    <?php if($userTable['user_image']==''){ ?>
                                                                        <div class="avatar translateX-axis avatar-sm">
                                                                            <span class="avatar-title rounded-circle"><?php echo $trimmedUserName; ?></span>
                                                                        </div>
                                                                    <?php }else{ ?>
                                                                        <div class="avatar translateY-axis avatar-sm">
                                                                            <img alt="avatar" src="<?php echo $userTable['user_image']; ?>" class="rounded-circle" />
                                                                        </div>
                                                                    <?php } ?>
                                                                </div>
                                                                <p class="align-self-center mb-0 admin-name"><?php echo $userTable["user_name"]; ?> </p>
                                                            </div>
                                                        </td>
                                                                            ...
                                                                            <div class="modal-content">
                                                                                <form method="post" enctype="multipart/form-data">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="row">
                                                                                            <div class="col-md-6">
                                                                                                <input type="text" name="user_name" id="user_name<?php echo $count ?>" class="form-control mb-3" placeholder="Employee Name" value="<?php echo $userTable['user_name']; ?>">
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <input type="text" name="employee_id" id="employee_id<?php echo $count ?>" class="form-control mb-3" placeholder="Employee id" value="<?php echo $userTable['employee_id']; ?>">
                                                                                            </div>
                                                                                        </div>

                                                                                        <div class="row">
                                                                                            <div class="col-md-6">
                                                                                                <input type="date" name="user_doj" id="user_doj<?php echo $count ?>" class="form-control mb-3" placeholder="Employee Date of Joining" value="<?php echo $userTable['user_doj']; ?>">
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <input type="text" name="user_phone_number" id="user_phone_number<?php echo $count ?>" class="form-control mb-3" placeholder="Whatsapp Number" value="<?php echo $userTable['user_phone_number']; ?>">
                                                                                            </div>
                                                                                        </div>

                                                                                        <div class="row">
                                                                                            <div class="col-md-6">
                                                                                                <input type="email" name="office_email" id="office_email<?php echo $count ?>" class="form-control mb-3" placeholder="Office Email Id" value="<?php echo $userTable['office_email']; ?>">
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <input type="email" name="user_email" id="user_email<?php echo $count ?>" class="form-control mb-3" placeholder="Email Id" value="<?php echo $userTable['user_email']; ?>">
                                                                                            </div>
                                                                                        </div>
                                                                                        
                                                                                        <div class="row">
                                                                                            <div class="col-md-6">
                                                                                                <select type="text" name="designation_id" id="designation_id<?php echo $count ?>" class="form-control mb-3" autocomplete="off" required>
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <select type="text" name="position_id" id="position_id<?php echo $count ?>" class="form-control mb-3" autocomplete="off" required>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-6">
                                                                                                <select type="text" name="department_id" id="department_id<?php echo $count ?>" class="form-control mb-3" placeholder="Team Name" autocomplete="off" required>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-8">
                                                                                                ...
                                                                                                <input type="file" id="user_image-file<?php echo $count ?>" name="user_image" class="form-control">
                                                                                            </div>
                                                                                            <div class="col-md-4">
                                                                                                <img src="<?php echo $userTable['user_image']; ?>"id="user_image-file<?php echo $count ?>" width="50" height="50">
                                                                                            </div> 
                                                                                        </div>
