<?php
    ...
    if(isset($_POST['add'])){
     ...
     $sql = $conn->query($query)->execute();
        if($sql['status']){
            header('Location: position.php?msg=Position added!');    
        }
    }
    ...
    if(isset($_POST['edit'])){
        ...
        $query = "UPDATE position SET position_name='$position_name' WHERE position_id='$position_id'";
        $sql = $conn->query($query)->execute();
           if($sql['status']){
               header('Location: position.php?msg=Position Updated!');    
           }
    }
    ...
    if(isset($_POST['delete'])){
        ...
        $sql = $conn->query($query)->execute();
        if($sql['status']){
            header('Location: position.php?msg=Position Deleted!');    
        }
    }
?>
<!DOCTYPE html>
                                                ...
                                                <div class="modal-content">
                                                    <form method="post" enctype="multipart/form-data">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="addAdminTitle">Add Position</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <input type="text" name="position_name" id="position_name" class="form-control" placeholder="Position Name" autocomplete="off" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <tbody>
                                            <?php
                                                 ...
                                                 if($sql['status']){  
                                                     $result =$sql['body'];                                            
                                                     $count = 1;
                                                     while($positionTable = $result->fetch_assoc()){
                                            ?>
                                                        <tr>
                                                            <td class="text-center"><?php echo $count++ ?></td>
                                                            <td class="text-center"><?php echo $positionTable["position_name"] ?></td>
                                                                        ...
                                                                        <div class="modal fade" id="edit<?php echo $count ?>" tabindex="-1" role="dialog" aria-labelledby="addAdminTitle<?php echo $count ?>" style="display: none;" aria-hidden="true">
                                                                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                                                                <div class="modal-content">
                                                                                    <form method="post" enctype="multipart/form-data">
                                                                                        <div class="modal-header">
                                                                                            <h5 class="modal-title" id="addAdminTitle<?php echo $count ?>">Edit Position</h5>
                                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                                                                                            </button>
                                                                                        </div>
                                                                                        <div class="modal-body">
                                                                                            ...
                                                                                            <div class="col-md-12 mb-2">
                                                                                                <label>Position Name</label>
                                                                                                    <input type="text" name="position_name" id="position_name<?php echo $count ?>" class="form-control" placeholder="Position Name" autocomplete="off" value="<?php echo $positionTable['position_name'] ?>">
                                                                                                </div>
                                                                                            </div>
                                                                                            <input type="hidden" name="positionId" value="<?php echo $positionTable["position_id"] ?>">
                                                                                        </div>
                                                                                        <div class="modal-footer">
                                                                                            <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Discard</button>
                                                                        ...
                                                                        <div class="modal fade" id="deleteAdmin<?php echo $count ?>" tabindex="-1" role="dialog" aria-labelledby="addAdminTitle" style="display: none;" aria-hidden="true">
                                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                                <div class="modal-content">
                                                                                    <form method="post">
                                                                                        <div class="modal-header">
                                                                                            <h5 class="modal-title" id="addAdminTitle">Delete Position</h5>
                                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                                                                                            </button>
                                                                                        </div>
                                                                                        <div class="modal-body">
                                                                                            <p class="modal-text">Are you sure to delete <?php echo $positionTable["position_name"] ?>!</p>
                                                                                            <input type="hidden" name="positionId" value="<?php echo $positionTable["position_id"] ?>">
                                                                                        </div>
                                                                                        <div class="modal-footer">
