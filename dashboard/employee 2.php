...
if (isset($_POST['add'])) {
    ...
    $department = $_POST['team_name'];

    $offerImage = $_FILES['offerImage']['name'];
    $appoinmentImage = $_FILES['appoinmentImage']['name'];

    $query = "INSERT INTO user (user_name, user_doj, employee_id, user_phone_number, off_email, user_email, position, department) 
    VALUES ('$user_name','$user_doj','$employee_id', '$user_phone_number','$off_email','$user_email','$position', '$department')";
    $sql = $conn->query($query)->execute();
    if ($sql['status']) {
        $query1 = "SELECT * FROM user ORDER BY id DESC LIMIT 1";
        ...
        if ($sql1['status']) {
            ...
            if (in_array($resumetype, $allowTypes)) {
                if (move_uploaded_file($_FILES["offerImage"]["tmp_name"], $resumename)) {
                    $query2 = "UPDATE user SET offerImage = '$resumename' WHERE id = '$received_id'";
            ...
            if (in_array($resumetype, $allowTypes)) {
                if (move_uploaded_file($_FILES["appoinmentImage"]["tmp_name"], $resumename)) {
                    $query2 = "UPDATE user SET appoinmentImage = '$resumename' WHERE id = '$received_id'";
                    $sql2 = $conn->query($query2)->execute();
                    if ($sql2['status']) {
                        header('Location: employee.php?msg=Employee added!');
                    }
...
if (isset($_POST['edit'])) {
    ...
    user_phone_number='$user_phone_number', off_email='$off_email', user_email='$user_email', position='$position',department='$department'
     WHERE user_id='$id'";
    $sql3 = $conn->query($query3)->execute();
    if ($sql3['status']) {
        if ($offerImage) {
            $extension = pathinfo($offerImage, PATHINFO_EXTENSION);
            $imageName = "upload/offer/" . $id . "." . $extension;
            ...
            if (in_array($extension, $allowedTypes)) {
                if (move_uploaded_file($_FILES["offerImage"]["tmp_name"], $imageName)) {
                    $query4 = "UPDATE personal SET offerImage='$imageName' WHERE id = '$id'";
        ...
        if ($appoinmentImage) {
            ...
            $imageName = "upload/app/" . $id . "." . $extension;
            $allowedTypes = array('jpg', 'JPG', 'png', 'PNG', 'jpeg', 'JPEG', 'gif', 'GIF', 'pdf', 'PDF');
            if (in_array($extension, $allowedTypes)) {
                if (move_uploaded_file($_FILES["appoinmentImage"]["tmp_name"], $imageName)) {
                    $query4 = "UPDATE personal SET appoinmentImage='$imageName' WHERE user_id = '$id'";
                    $conn->query($query4)->execute();
                }
            }
        }
                                                    ...
                                                    <form method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="user_id" id="user_id" class="form-control mb-3" placeholder="Employee Id" autocomplete="off" required>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="email" name="off_email" id="off_email" class="form-control mb-3" placeholder="Office Email Id" autocomplete="off" required>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <select type="text" name="position" id="position" class="form-control mb-3" placeholder="Designation" autocomplete="off" required>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <select type="text" name="team_name" id="team_name" class="form-control mb-3" placeholder="Team Name" autocomplete="off" required>
                                                                        <option value="" selected value disabled>Select Team Name</option>
                                                                        <option value="Developer">Developer</option>
                                                                        <option value="Front_Developer">Front Developer</option>
                                                                        <option value="Business_Development_Team">Business Development Team</option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label>Appoinment Letter Copy</label>
                                                                                ...
                                                                                <form method="post" enctype="multipart/form-data">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <input type="text" name="user_id" id="user_id" class="form-control mb-3" placeholder="Employee id" value="<?php echo $userTable['user_id']; ?>">
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <input type="number" name="user_phone_number" id="user_phone_number" class="form-control mb-3" placeholder="Whatsapp Number" value="<?php echo $userTable['user_phone_number']; ?>">
                                                                                            </div>
                                                                                        </div>

                                                                                        <div class="row">
                                                                                            <div class="col-md-6">
                                                                                                <input type="email" name="off_email" id="off_email" class="form-control mb-3" placeholder="Office Email Id" value="<?php echo $userTable['off_email']; ?>">
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-6 mb-2">
                                                                                                <select name="position" id="position" class="form-control">
                                                                                                    <?php
                                                                                                    $Web_Developer = $UI_Designer = $Business_Development = "";
                                                                                                    switch ($userTable['position']) {
                                                                                                        case '0':
                                                                                                            $Web_Developer = 'selected';
                                                                                                            break;
                                                                                                        case '1':
                                                                                                            $UI_Designer = 'selected';
                                                                                                            break;
                                                                                                        case '2':
                                                                                                    ...
                                                                                                    <option value="UI/UX Designer" <?php echo $UI_Designer; ?>>UI/UX Designer</option>
                                                                                                    <option value="Business Development" <?php echo $Business_Development; ?>>Business Development</option>
                                                                                                </select>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col-md-6 mb-2">
                                                                                                <select name="team_name" id="team_name" class="form-control">
                                                                                                    <?php
                                                                                                    $Developer = $Front_Developer = $Business_Development_Team = "";
                                                                                                    switch ($userTable['team_name']) {
                                                                                                        case '0':
                                                                                                            $Developer = 'selected';
                                                                                                            break;
                                                                                                        case '1':
                                                                                                            $Front_Developer = 'selected';
                                                                                                            break;
                                                                                                        case '2':
                                                                                                            $Business_Development_Team = 'selected';
                                                                                                            break;
                                                                                                    }
                                                                                                    ?>
                                                                                                    <option value="Developer" <?php echo $Developer; ?>>Developer</option>
                                                                                                    <option value="Front Developer" <?php echo $Front_Developer; ?>>Front Developer</option>
                                                                                                    <option value="Business Development Team" <?php echo $Business_Development_Team; ?>>Business Development Team</option>
                                                                                                </select>
                                                                                            </div>
                                                                                        </div>
