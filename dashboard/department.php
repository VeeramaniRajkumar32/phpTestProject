<?php
    ...
    if(isset($_POST['edit'])){
        ...
        $sql = $conn->query($query)->execute();
           if($sql['status']){
               header('Location: department.php?msg=Department Updated!');    
           }
    }
                                                ...
                                                <div class="modal-content">
                                                    <form method="post" enctype="multipart/form-data">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="addAdminTitle">Add Department</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <input type="text" name="department_name" id="department_name" class="form-control" placeholder="Department Name" autocomplete="off" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <tbody>
                                            <?php
                                                 ...
                                                 if($sql['status']){  
                                                     $result =$sql['body'];                                            
                                                     $count = 1;
                                                     while($departmentTable = $result->fetch_assoc()){
                                            ?>
                                                        <tr>
                                                            <td class="text-center"><?php echo $count++ ?></td>
                                                            <td class="text-center"><?php echo $departmentTable["department_name"] ?></td>
                                                                        ...
                                                                        <div class="modal fade" id="edit<?php echo $count ?>" tabindex="-1" role="dialog" aria-labelledby="addAdminTitle<?php echo $count ?>" style="display: none;" aria-hidden="true">
                                                                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                                                                <div class="modal-content">
                                                                                    <form method="post" enctype="multipart/form-data">
                                                                                        <div class="modal-header">
                                                                                            <h5 class="modal-title" id="addAdminTitle<?php echo $count ?>">Edit Department</h5>
                                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                                                                                            </button>
                                                                                        </div>
                                                                                        <div class="modal-body">
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <label>Department Name</label>
                                                                                                    <input type="text" name="department_name" id="department_name<?php echo $count ?>" class="form-control" placeholder="Department Name" autocomplete="off" value="<?php echo $departmentTable['department_name'] ?>">
                                                                                                </div>
                                                                                            </div>
                                                                                            <input type="hidden" name="deptId" value="<?php echo $departmentTable["department_id"] ?>">
                                                                                        </div>
                                                                                        <div class="modal-footer">
                                                                                            <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Discard</button>
                                                                            ...
                                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                                <div class="modal-content">
                                                                                    <form method="post">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            <p class="modal-text">Are you sure to delete <?php echo $departmentTable["department_name"] ?>!</p>
                                                                                            <input type="hidden" name="deptId" value="<?php echo $departmentTable["department_id"] ?>">
                                                                                        </div>
                                                                                        <div class="modal-footer">
