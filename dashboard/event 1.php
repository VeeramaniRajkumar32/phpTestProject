...
if (isset($_POST['add'])) {
    ...
    if ($sql['status']) {
        ...
        if ($sql1['status']) {
            ...
            $resumename1 = "upload/offer/" . $received_id . "." . $resumetype1;
...
if (isset($_POST['edit'])) {
    ...
    if ($sql3['status']) {
        if ($event_image) {
            ...
            $imageName = "upload/offer/" . $event_id . "." . $extension;
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $branchTable1["branch_name"]; ?></td>
                                                                                ...
                                                                                <form method="post" enctype="multipart/form-data">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <select type="text" name="branch_id" id="branch_id" class="form-control mb-3" >
